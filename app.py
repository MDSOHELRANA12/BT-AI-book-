...
st.markdown("""
    ...
    /* অকেজো গ্যাপ কমানোর জন্য */
    iframe { margin-bottom: -10px; border-radius: 10px; }
    </style>
    ...
    try:
        ...
        if videos:
            for v in videos:
                ...
                # --- সরাসরি অ্যাড পজিশন ---
                # এখানে হাইট কমিয়ে দিয়েছি যাতে বেশি জায়গা নষ্ট না হয়
    ...
    if st.session_state.user:
        ...
        if st.button("🚀 Publish Now") and up_file:
            with st.spinner("Uploading..."):
                ...
                supabase.table("videos").insert({"video_url": vid_url, "uploader_name": st.session_state.user, "uploader_pic": st.session_state.pic, "views": 1, "likes": 0, "followers": 0}).execute()
