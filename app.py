...
# --- ১. সুপাবেস কানেকশন ও কনফিগারেশন ---
...
if tab == "🌍 World Feed":
    try:
        ...
        for index, v in enumerate(data):
            ...
            # স্ট্যাটাস (Views, Likes, Followers)
            st.markdown(f'''
            ...
            st.markdown('</div>', unsafe_allow_html=True) # ভিডিও কার্ড শেষ

            # প্রতি ২ ভিডিও পর বড় ব্যানার অ্যাড
            if (index + 1) % 2 == 0:
                st.markdown(f'''
...
# --- ৬. ভিডিও আপলোড সেকশন ---
    ...
    if st.session_state.user:
        ...
        if st.button("🚀 Publish") and v_file:
            with st.spinner("🤖 ওজন শূন্য করা হচ্ছে..."):
                try:
                    ...
                    st.error("Wait a minute and try again.")
