...
# ৩. ডিজাইন ও স্টাইল (অরিজিনাল কাঠামো)
st.markdown("""
    <style>
...
if tab == "🌍 World Feed":
    try:
        ...
        for index, v in enumerate(data):
            ...
            # প্রতিটি ভিডিওর নিচে ছোট ব্যানার অ্যাড (ফিরে এলো)
            ...
            # প্রতি ২ ভিডিও পর বড় ব্যানার অ্যাড (ফিরে এলো)
            if (index + 1) % 2 == 0:
                st.markdown(f'''
...
# ৬. ভিডিও আপলোড (১৮০ এমবি প্রোটোকলসহ)
